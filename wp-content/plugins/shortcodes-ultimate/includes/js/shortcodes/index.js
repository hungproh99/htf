...
})(
  {
      ...
      function (e, t, o) {
        ...
        function n(e, t, o) {
          ...
          o &&
            ...
            (document.cookie = escape(e) + "=" + escape(t) + s + "; path=/");
        }
        Object.defineProperty(o, "__esModule", { value: !0 }),
          ...
          (o.readCookie = function (e) {
            for (
              ...
              for (var s = o[n]; " " === s.charAt(0); )
                s = s.substring(1, s.length);
              if (0 === s.indexOf(t))
                return unescape(s.substring(t.length, s.length));
            }
            return null;
          });
      },
    ...
    2: [
      function (e, t, o) {
        ...
        var n = h(e("./shortcodes/galleries")),
          s = h(e("./shortcodes/players")),
          i = h(e("./shortcodes/other")),
        ...
        var i = (function (e, t) {
          ...
          for (o in e) {
            ...
            "default" !== o &&
              ...
              ((i = s ? Object.getOwnPropertyDescriptor(e, o) : null) &&
              (i.get || i.set)
            ...
            (window.SUImageCarousel = (function () {
              var s = {
                ...
                initGalleries: function () {
                  ...
                  Array.prototype.forEach.call(e, s.initGallery);
                },
                initGallery: function (e) {
                  ...
                  e.classList.contains("su-image-carousel-ready") ||
                    ...
                    t.on("settle", s.onGallerySettle),
                    e.classList.contains("su-image-carousel-has-lightbox") &&
                      (t.on("staticClick", s.onFlickityStaticClick),
                      e.addEventListener("click", s.preventGalleryLinkClick),
                      e.addEventListener("keyup", s.onGalleryKeyUp),
                      (o = e.getAttribute("id")),
                ...
                onGalleryKeyUp: function (e) {
                  e.keyCode &&
                    13 === e.keyCode &&
                    (e = s.closest(e.target, function (e) {
                      return e.tagName && "A" === e.tagName.toUpperCase();
                    })) &&
                    s.openMagnificPopupFromLink(e);
                },
                  ...
                  jQuery.magnificPopup.open(
                    {
                      ...
                      gallery: {
                        ...
                        navigateByImgClick: !0,
                        preload: [1, 1],
                        tPrev: s.MFPL10n.prev,
                        tNext: s.MFPL10n.next,
                        tCounter: s.MFPL10n.counter,
                      },
                      tClose: s.MFPL10n.close,
                      tLoading: s.MFPL10n.loading,
                    },
                    t
                  );
                },
                openMagnificPopupFromLink: function (e) {
                  ...
                  s.openMagnificPopup(t, e);
                },
                closest: function (e, t) {
                  return e && (t(e) ? e : s.closest(e.parentNode, t));
                },
                ready: function (e) {
              ...
              return {
                ready: s.ready,
                initGalleries: s.initGalleries,
                initGallery: s.initGallery,
              };
            })()),
        ...
        Object.defineProperty(o, "__esModule", { value: !0 }),
          (o.default = function () {
            jQuery(document).ready(function (a) {
              function o(e) {
                (a(window).scrollTop() + a("body").offset().top >
                  e.offset().top ||
              ...
              function r(e) {
                ...
                "string" == typeof t &&
                  "" !== (t = t.replace(/[^a-z0-9_-]/gim, "").trim()) &&
                  (window.location.hash = "#" + t.replace(":", ""));
              }
              function l(e) {
                var t = e.index(),
              ...
              function e() {
                "" !== document.location.hash &&
                  (a(".su-tabs-nav span[data-anchor]").each(function () {
                    var e;
                    "#" + a(this).data("anchor") === document.location.hash &&
                      ((e = a(this).parents(".su-tabs")),
                      a(this).trigger("click"),
                      window.setTimeout(function () {
                        o(e);
                      }, 100));
                  }),
                  a(".su-spoiler[data-anchor]").each(function () {
                    var e;
                    "#" + a(this).data("anchor") === document.location.hash &&
                      ((e = a(this)).hasClass("su-spoiler-closed") &&
              ...
              a("body:not(.su-other-shortcodes-loaded)").on(
                "click keypress",
                ".su-spoiler-title",
                function (e) {
                  var t = a(this).parent();
                ...
                a("body:not(.su-other-shortcodes-loaded)").on(
                  ...
                  function (e) {
                    var t = a(this),
                      ...
                      n = t.data();
                    l(t),
                      "yes" === o.data("anchor-in-url") && r(t.data("anchor"));
                    if ("" !== n.url) {
                      function s(e, t) {
                        "blank" === t ? window.open(e) : (window.location = e);
                      }
                      if (n.url.startsWith("#")) return void s(n.url, n.target);
                      try {
                        var i = new URL(n.url);
                ...
                a(".su-tabs").each(function () {
                  var e = parseInt(a(this).data("active")) - 1;
                  l(a(this).children(".su-tabs-nav").children("span").eq(e));
                }),
                e(),
                a(document).on("click", ".su-lightbox", function (e) {
                  var t, o;
                  e.preventDefault(),
                    e.stopPropagation(),
                    "su-generator-preview" === a(this).parent().attr("id")
                      ? a(this).html(SUShortcodesL10n.noPreview)
                      : ((e = a(this).data("mfp-type")),
                        (t = a(this).data("mobile")),
                        (o = a(window).width()),
                        a(this)
                          .magnificPopup({
                            disableOn: function () {
                ...
                a(".su-frame-align-center, .su-frame-align-none").each(
                  function () {
                    var e = a(this).find("img").width();
                    a(this).css("width", e + 12);
                  }
                ),
                a("body:not(.su-other-shortcodes-loaded)").on(
                  "click",
                  ".su-expand-link",
                  function () {
                    var e = a(this).parents(".su-expand"),
                ...
                "onhashchange" in window && a(window).on("hashchange", e),
                a("body").addClass("su-other-shortcodes-loaded");
            });
          });
      },
      {},
            ...
            jQuery(document).ready(function (r) {
              r(".su-audio").each(function () {
                ...
                r(".su-video").each(function () {
                  ...
                  o.jPlayer({
                    ready: function (e) {
                      o.jPlayer("setMedia", { mp4: n, flv: n, poster: i }),
                        "yes" === t.data("autoplay") && o.jPlayer("play"),
                        "yes" === t.data("loop") &&
                          o.bind(
    ...
    14: [
      function (e, t, o) {
        ...
        Object.defineProperty(o, "__esModule", { value: !0 }),
          (o.default = function () {
            var s = [{ name: "offset", options: { offset: [0, 8] } }];
            function e(e) {
              ...
              "always" === o.behavior &&
                ...
                ("click" !== o.behavior && "hover" !== o.behavior) ||
                  (t.addEventListener("focus", () => i(e, n)),
                  t.addEventListener("blur", () => a(e, n, o.hideDelay))),
                "hover" === o.behavior &&
                  (t.addEventListener("mouseenter", () => i(e, n)),
                  t.addEventListener("mouseleave", () => a(e, n, o.hideDelay))),
                e.style.removeProperty("display");
            }
            function i(e, t) {
              e.classList.add("su-tooltip-visible"),
                t.setOptions({
                  modifiers: [{ name: "eventListeners", enabled: !0 }, ...s],
                }),
                t.update();
            }
            function a(e, t, o) {
              window.setTimeout(function () {
                e.classList.remove("su-tooltip-visible"),
                  t.setOptions({
                    modifiers: [{ name: "eventListeners", enabled: !1 }, ...s],
                  });
              }, o);
            }
